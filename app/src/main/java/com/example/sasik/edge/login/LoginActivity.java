package com.example.sasik.edge.login;
...
import com.example.sasik.edge.HomeActivity;
import com.example.sasik.edge.KinveyActivity;
import com.example.sasik.edge.MainActivity;
import com.example.sasik.edge.R;
...
public class LoginActivity extends KinveyActivity {
    ...
    private void signUpUser(String username, String password){
        getClient().user().create(username,password,callback);
    }

    private void signInUser(String username,String password){
        getClient().user().login(username,password,callback);
    }
